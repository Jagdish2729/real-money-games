    ...
    <main className="min-h-screen bg-[#07080b] text-white">
      <div className="mx-auto max-w-6xl px-5 pb-12 sm:px-8">
        <header className="flex h-20 items-center justify-between border-b border-white/10">
          ...
          <a href="/wallet" className="rounded-xl border border-white/15 px-4 py-2.5 text-sm font-semibold hover:border-white/30">
            Wallet
          </a>
        </header>
        ...
        <section className="grid gap-5 md:grid-cols-2">
          {games.map((game) => (
            <a
              key={game.title}
              href={game.href}
              className="group rounded-3xl border border-white/10 bg-white/[0.035] p-6 transition hover:-translate-y-1 hover:border-white/20 hover:bg-white/[0.055] sm:p-8"
            >
              <div className="flex items-start justify-between">
                <span className="flex h-16 w-16 items-center justify-center rounded-2xl bg-white text-4xl text-black shadow-lg shadow-black/20">
                  {game.icon}
                </span>
                <span className="rounded-full border border-white/10 px-3 py-1.5 text-xs font-bold text-white/50">
                  {game.odds}
                </span>
              </div>
        ...
        <section className="mt-8 rounded-2xl border border-white/10 bg-white/[0.025] p-5 text-sm text-white/40">
